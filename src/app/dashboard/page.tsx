    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 px-4">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="space-y-3">
          ...
          <Link href="/ai-analyzer" className="block">
            <div className="group rounded-2xl bg-gradient-to-r from-violet-600 to-purple-600 p-4 shadow-lg transition-all hover:shadow-xl hover:scale-[1.02]">
              <div className="flex items-center gap-4">
                <span className="text-3xl">🧠</span>
                <div>
                  <h2 className="text-lg font-bold text-white">AI Analyzer</h2>
